...
// const apiKey = 'https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&appid={apiKey}';
...
function displayCurrentWeather(data) {
    ...
    document.getElementById('currentWeatherCity').textContent = `Weather in ${cityName}:`;
    document.getElementById('currentTemperature').textContent = `Temperature: ${temperature}°C`;
    document.getElementById('currentIcon').textContent = `Description: ${description}`; // Updated the ID to match an existing element
}
